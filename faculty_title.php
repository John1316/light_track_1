    ...
    <body>
		...
		<section class="blog-section blog-style-two pt-100 pb-70">
			<div class="container">
				...
				<div class="row">
					<?php 
					$submajors_stat = "SELECT * FROM `faculties` where `faculty_id`=".$_GET['faculty_id']." ";
					...
					<div class="col-lg-4 col-sm-6">
                        ...
                        <div class="blog-img">
								<a>
									<img src="images/<?php echo $result['image'] ?>" alt="blog image">
                                </a>
							</div>
							<div class="blog-text">
								...
								<a href="faculty_details.php?faculty_id=<?php echo $result['faculty_id'] ?>" class="blog-btn">
									Read More
