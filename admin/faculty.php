<?php
    ...
    include('functions/faculty_function.php');
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $categories = "SELECT * from `faculties`";
                                                ...
                                                <tr>
                                                    ...
                                                    <button  data-toggle="modal" data-target="#update_faculty<?php echo $result['faculty_id'] ?>" class="pl-0 btn btn-transparent"><i class="badge-circle badge-circle-light-secondary bx bx-edit font-medium-1"></i></button>

                                                    <form  method="post">
                                                        <input type="hidden" name="faculty_id" id="faculty_id" value="<?php echo $result['faculty_id'] ?>">
                                                        <button name="delete_faculty" type="submit" class="pl-0 btn btn-transparent" onclick="return confirm('Are you want to delete <?php echo $result['faculty_id']; ?>')"><i class="badge-circle badge-circle-light-secondary bx bx-trash font-medium-1"></i></button>
                                                    </form>
                                                  
                                                    </td>
                                                </tr>
                                                <div id="update_faculty<?php echo $result['faculty_id'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="add_fauclty" class="btn btn-primary">Add faculty</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                    </form>
                </div>
