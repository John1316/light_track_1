...
if(isset($_POST['add_consultation'])){
    ...
    $insert_consultation = "INSERT INTO `consultations` (`user_id`, `advisor_id`, `session_field`, `preferred_date`, `preferred_time`, `screenshot`, `session_fees`, `status`) VALUES ('$user_id', '$advisor_id', '$session_field', '$preferred_date', '$preferred_time', '$screenshot', '$session_fees', '$status')";
...
if(isset($_POST['update_consultation'])){
    ...
    $update_consultation = "UPDATE `consultations` SET `user_id`='$user_id', `advisor_id`='$advisor_id', `session_field`='$session_field', `preferred_date`='$preferred_date', `preferred_time`='$preferred_time', `screenshot`='$screenshot', `session_fees`='$session_fees', `status`='$status' WHERE `consultation_id`='$id' ";
